        ...
        <div className="artwork flex py-24 pb-40 sm:py-40 lg:pb-60 font-libre-baskerville">
          <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-20 md:gap-40 xl:gap-20'>
            <div className='image-showing relative md:col-span-2 grid md:grid-cols-3 md:grid-rows-[minmax(0,_auto)_minmax(0,_1fr)] xl:grid-rows-[repeat(2,_minmax(0,_auto))]'>
              ...
              <div className="image-title self-start p-5 sm:p-12 md:p-16 md:pr-0 md:pt-0 mr-12 xs:mr-24 sm:mr-32 md:mr-0 -mt-24 md:-mt-0 md:-ml-40 xl:-ml-40 bg-white">
              ...
              <button onClick={() => setLightbox(lightbox => !lightbox)} className='text-white uppercase font-bold tracking-widest text-xs bg-black absolute top-5 right-5 md:right-auto md:top-auto md:bottom-5 md:left-5  py-3 px-6 md:py-4 md:px-8 flex gap-2 items-center justify-center'>
                View Image <ViewIcon />
              </button>
            ...
            <div className="details md:col-span-2 xl:col-auto flex flex-col self-center relative md:mx-24 xl:mx-auto xl:mt-40">
              ...
              <p className='grow leading-8 text-gray-600'>{artwork.description}</p>
